...
{FEATURED_COMPANIES.map((company) => (
  <motion.div
              key={company.name}
className="group flex flex-col gap-10 py-12 border-b border-outline-variant/30 cursor-pointer transition-all duration-500 hover:bg-primary-fixed hover:px-8 hover:rounded-2xl"              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            >
              <div className="aspect-video overflow-hidden rounded-2xl bg-surface-container">
