  ...
  return (
    <main className="min-h-screen bg-[#090909] text-[#f5f1ec] overflow-x-hidden selection:bg-[#e7c3cb] selection:text-black">
      <div className="relative">
        <section className="relative -mr-8 md:-mr-12 lg:-mr-16 rounded-bl-[30px] bg-[#e7c3cb] text-black pt-12 pb-20 px-8 md:px-12 lg:px-16 min-h-[820px]">
          ...
          <div className="mt-8 max-w-[760px]">
            ...
            <h2 className="mt-10 text-[72px] leading-[1.08] tracking-[-0.045em] font-normal max-w-[680px]">
          ...
          <div className="absolute bottom-20 left-8 right-8 md:left-12 md:right-12 lg:left-16 lg:right-16 border-t border-black/10 pt-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-12">
              {[
                ...
                <div key={item.label}>
                  <p className="text-[10px] tracking-[0.24em] uppercase opacity-40">
                    {item.label}
                  </p>
      ...
      <section className="relative px-8 md:px-12 lg:px-16 pt-24 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_0.8fr] gap-20 lg:gap-28">
          <div>
            <div className="max-w-[420px]">
              <p className="text-[42px] md:text-[52px] leading-[1.34] tracking-[-0.045em] text-[#f1ede7] font-extralight">
                Founded by veterans from Varjo, IXI explores a quieter
                direction for consumer technology: adaptive eyewear designed to
                integrate naturally into everyday life rather than compete for
                attention.
              </p>

              <div className="mt-16 space-y-12 text-[16px] leading-[1.9] tracking-[-0.02em] text-[#b5aea8]">
                <p>
                  By combining precision optics, industrial design and ambient
                  computing principles, the company is building technology that
                  feels almost invisible, responding to human behaviour instead
                  of demanding constant focus.
                </p>

                <p>
                  The broader philosophy behind IXI removes spectacle from the
                  experience entirely. The product is designed to disappear into
                  use: soft interfaces, restrained form language and seamless
                  interaction replacing the visual noise commonly associated
          ...
          <div className="max-w-[620px] lg:ml-auto w-full">
            <div className="overflow-hidden rounded-[18px] bg-[#0d0d0d] min-h-[520px]">
