...
<h1 className="mt-10 md:mt-14 text-[36px] sm:text-[60px] md:text-[96px] leading-[0.9] tracking-[-0.05em] font-extralight font-['Inter',sans-serif]">
  {company.name}
</h1>
...
<div className="grid grid-cols-1 lg:grid-cols-[700px_360px] justify-between gap-8 md:gap-12 items-start">
  <div>            {/* Lead paragraph — Inter extralight, ~26px, max ~480px wide */}
    <p className="text-[13px] md:text-[18px] leading-[1.75] tracking-[-0.01em] text-[#f1ede7] font-extralight font-['Inter',sans-serif] max-w-[520px]">
  {company.lead}
</p>
